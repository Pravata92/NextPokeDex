...
const PokeCard = ({name, img, paddedIndex, id}) =>{
    return(
        <div className="rounded box-content mx-auto border-2 bg-gray-100 border-black mb-4 overflow-hidden shadow-lg max-w-screen-md" >
        <Link href={`/pokemon?id=${id }`}>
          <img className="flex-wrap mx-auto" src={img} style={{width:'250px', cursor: "pointer"}} alt="Mountain" />
        </Link>
